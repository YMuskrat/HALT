...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.command == "demo":
            ...
            _emit(_doctor(load_config(args.config), load_model=args.load_model))
            ...
            summary = evaluate(load_config(args.config), args.output_dir)
            _emit({"output_dir": args.output_dir, "methods": len(summary["methods"])})
            ...
            print(scaffold_method(args.method_id, args.output))
        return 0
